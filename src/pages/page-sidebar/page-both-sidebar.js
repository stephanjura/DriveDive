...
// Widget
import SideBar, { SideBarTwo } from '../../widget/sidebar';

function PageBothSideBar() {
  const listItems = [
    { id: 1, item: 'Lorem ipsum dolor sit amet, consectetur'},
    { id: 2, item: 'Quidem error quae illo excepturi nostrum blanditiis laboriosam'},
    { id: 3, item: 'Molestias, eum nihil expedita dolorum odio dolorem'},
      ...
      <div className="site-content">
        <PageHeader
          ...
          breadCrumbItems={[
            { label: 'Home', path: '/' },
            { label: 'Pages', path: '#' },
            { label: 'Page Both Sidebar', path: '#', active: true },
          ]}
        />
...
export default PageBothSideBar;
